...
./create_waveform_catalog.sh "/opt/genomics/WaveFormProcessedFiles/codes/CsvOutputs_co2_v2" $(pwd)/waveform_catalog_v2.txt "/opt/genomics/WaveFormProcessedFiles/codes/WaveFormProcessedFiles_2_stps"
